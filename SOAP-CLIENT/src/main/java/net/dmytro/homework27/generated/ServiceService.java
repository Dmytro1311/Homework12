 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "http://homework27.dmytro.net/", wsdlLocation = "http://localhost:9999/basket?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("http://homework27.dmytro.net/", "ServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/basket?wsdl");
    ...
    public net.dmytro.homework27.generated.Service getServicePort() {
        return super.getPort(new QName("http://homework27.dmytro.net/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public net.dmytro.homework27.generated.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://homework27.dmytro.net/", "ServicePort"), Service.class, features);
    }
